...
import com.walhalla.telegramstickers.databinding.FragmentHomeBinding
...
class MainFragment : AbstractStatusListFragment() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = StickerAdapter(getContext(), m!!.getBlockedItems(), db!!.stickerDao(), isFavorite)
    }
...
//                startActivityForResult(new Intent(MainFragment.this.getActivity(), AddStickerActivity.class), 1));
        ...
        val lm = adapter!!.getGridLayoutManager(getContext(), numberOfColumns)
    ...
    public override fun handleProxy(data: StickerDb) {
        val intent = newIntent(getContext(), data._id)
